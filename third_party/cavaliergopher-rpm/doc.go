...
Packages may be validated using MD5Check. SOW verifies repository metadata
with its maintained OpenPGP implementation and preserves embedded RPM
signatures byte-for-byte; package-signature validation remains the native RPM
