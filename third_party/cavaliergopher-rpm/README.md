...
> SOW local parser snapshot: this tree is pinned to upstream v1.3.0 and is used
> only for RPM header/metadata parsing. The abandoned x/crypto OpenPGP
> verification helpers are intentionally removed; see `SOW-PATCHES.md` for
> provenance, security rationale, and validation requirements.
