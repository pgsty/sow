...
func sealDerivedStateDirectoryMutation(directory *os.File, sequence uint64) (derivedStateDirectoryMutationEpoch, error) {
	...
	times := []unix.Timeval{
		unix.NsecToTimeval(stat.Atimespec.Sec*1_000_000_000 + stat.Atimespec.Nsec),
	...
	if afterStat.Mtimespec.Sec != markerSeconds || afterStat.Mtimespec.Nsec != 0 {
		return derivedStateDirectoryMutationEpoch{}, nil
	}
...
func derivedStateDirectoryExpectedLinkDelta(destinationWasAbsent bool) uint64 {
